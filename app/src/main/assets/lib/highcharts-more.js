...
(function (w) {
    ...
    (function (a) {
        var r = a.deg2rad, v = a.isNumber, t = a.pick, n = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, e = this.chart, h = 2 * (a.slicedOffset || 0), b = e.plotWidth - 2 * h,
                    e = e.plotHeight - 2 * h, c = a.center,
                    c = [t(c[0], "50%"), t(c[1], "50%"), a.size || "100%", a.innerSize || 0], f = Math.min(b, e), k, g;
                for (k = 0; 4 > k; ++k) g = c[k], a = 2 > k || 2 === k && /%$/.test(g), c[k] = n(g, [b, e, f, c[2]][k]) + (a ? h : 0);
                c[3] > c[2] && (c[3] = c[2]);
                return c
    ...
    (function (a) {
        ...
        var v = a.CenteredSeriesMixin, t = a.each, n = a.extend, p = a.merge, e = a.splat;
        n(r.prototype, {
            coll: "pane",
            init: function (a, b) {
                this.chart = b;
            ...
            render: function () {
                var a = this.options, b =
                    this.options.background, c = this.chart.renderer;
                this.group || (this.group = c.g("pane-group").attr({zIndex: a.zIndex || 0}).add());
                this.updateCenter();
                if (b) for (b = e(b), a = Math.max(b.length, this.background.length || 0), c = 0; c < a; c++) b[c] && this.axis ? this.renderBackground(p(this.defaultBackgroundOptions, b[c]), c) : this.background[c] && (this.background[c] = this.background[c].destroy(), this.background.splice(c, 1))
            },
    ...
    (function (a) {
        var r = a.each, v = a.extend, t = a.map, n = a.merge, p = a.noop, e = a.pick, h = a.pInt, b = a.wrap, c, f,
            k = a.Axis.prototype, g = a.Tick.prototype;
        a.radialAxisExtended || (a.radialAxisExtended = !0, c = {
            getOffset: p, redraw: function () {
                this.isDirty = !1
            },
            render: function () {
                this.isDirty = !1
            }, setScale: p, setCategories: p, setTitle: p
        }, f = {
            ...
            getLinePath: function (b, c) {
                b = this.center;
                var d = this.chart, a = e(c, b[2] / 2 - this.offset);
            ...
            postTranslate: function (b, c) {
                var d = this.chart, a = this.center;
                b = this.startAngleRad + b;
                return {x: d.plotLeft + a[0] + Math.cos(b) * c, y: d.plotTop + a[1] + Math.sin(b) * c}
            },
            getPlotBandPath: function (b, c, a) {
                var d = this.center, f = this.startAngleRad, g = d[2] / 2,
                    m = [e(a.outerRadius, "100%"), a.innerRadius, e(a.thickness, 10)], k = Math.min(this.offset, 0),
                    u = /%$/, p, y = this.isCircular;
                "polygon" === this.options.gridLineInterpolation ? d = this.getPlotLinePath(b).concat(this.getPlotLinePath(c,
                    !0)) : (b = Math.max(b, this.min), c = Math.min(c, this.max), y || (m[0] = this.translate(b), m[1] = this.translate(c)), m = t(m, function (b) {
            ...
            var d = a.angular, m = a.polar, k = g.isX, u = d && k, x, p = a.options, h = g.pane || 0,
                y = this.pane = a.pane && a.pane[h], h = y && y.options;
            if (d) {
                if (v(this, u ? c : f), x = !k) this.defaultRadialOptions = this.defaultRadialGaugeOptions
            } else m && (v(this, f), this.defaultRadialOptions = (x = k) ? this.defaultRadialXOptions : n(this.defaultYAxisOptions, this.defaultRadialYOptions));
            d || m ? (this.isRadial = !0, a.inverted = !1, p.chart.zoomType = null) : this.isRadial =
                !1;
            y && x && (y.axis = this);
            b.call(this, a, g);
        ...
        }), b(g, "getLabelPosition",
            function (b, c, a, g, f, k, p, x, h) {
                var d = this.axis, m = k.y, l = 20, u = k.align,
                ...
                d.isRadial ? (b = d.getPosition(this.pos, d.center[2] / 2 + e(k.distance, -25)), "auto" === k.rotation ? g.attr({rotation: q}) : null === m && (m = d.chart.renderer.fontMetrics(g.styles.fontSize).b - g.getBBox().height / 2), null === u && (d.isCircular ? (this.label.getBBox().width > d.len * d.tickInterval / (d.max - d.min) && (l = 0), u = q > l && q < 180 - l ? "left" : q > 180 + l && q < 360 - l ? "right" : "center") : u = "center", g.attr({align: u})),
                    b.x += k.x, b.y += m) : b = b.call(this, c, a, g, f, k, p, x, h);
                return b
    ...
    (function (a) {
        var r = a.each, v = a.pick, t = a.defined, n = a.seriesType, p = a.seriesTypes, e = a.Series.prototype,
            h = a.Point.prototype;
        n("arearange", "area", {
            lineWidth: 1,
            threshold: null,
            ...
            highToXY: function (b) {
                var c = this.chart, a = this.xAxis.postTranslate(b.rectPlotX, this.yAxis.len - b.plotHigh);
            ...
            translate: function () {
                ...
                r(b.points, function (f) {
                    var g = f.low, d = f.high, m = f.plotY;
            ...
            getGraphPath: function (b) {
                var c = [], a = [], k, g = p.area.prototype.getGraphPath, d, m, u;
                u = this.options;
                var l = this.chart.polar && !1 !== u.connectEnds, q = u.connectNulls, e = u.step;
                b = b || this.points;
                for (k = b.length; k--;) d = b[k], d.isNull || l || q || b[k + 1] && !b[k + 1].isNull || a.push({
                    plotX: d.plotX,
                    plotY: d.plotY,
                    doCurve: !1
                }), m = {
                ...
                b = g.call(this, b);
                e && (!0 === e && (e = "left"), u.step = {left: "right", center: "center", right: "left"}[e]);
                c = g.call(this, c);
                a = g.call(this, a);
                u.step = e;
                u = [].concat(b,
            ...
            drawDataLabels: function () {
                var b = this.data, c = b.length, a, k = [], g = this.options.dataLabels, d = g.align,
                    m = g.verticalAlign, u = g.inside, l, q, z = this.chart.inverted;
                if (g.enabled || this._hasPointLabels) {
                    for (a = c; a--;) if (l = b[a]) q = u ? l.plotHigh < l.plotLow : l.plotHigh > l.plotLow, l.y = l.high, l._plotY = l.plotY, l.plotY = l.plotHigh, k[a] = l.dataLabel, l.dataLabel = l.dataLabelUpper, l.below =
                        q, z ? d || (g.align = q ? "right" : "left") : m || (g.verticalAlign = q ? "top" : "bottom"), g.x = g.xHigh, g.y = g.yHigh;
                    e.drawDataLabels && e.drawDataLabels.apply(this, arguments);
                    for (a = c; a--;) if (l = b[a]) q = u ? l.plotHigh < l.plotLow : l.plotHigh > l.plotLow, l.dataLabelUpper = l.dataLabel, l.dataLabel = k[a], l.y = l.low, l.plotY = l._plotY, l.below = !q, z ? d || (g.align = q ? "left" : "right") : m || (g.verticalAlign = q ? "bottom" : "top"), g.x = g.xLow, g.y = g.yLow;
                    e.drawDataLabels && e.drawDataLabels.apply(this, arguments)
                }
                g.align = d;
                g.verticalAlign = m
            ...
            drawPoints: function () {
                var b = this.points.length, c, a;
                e.drawPoints.apply(this, arguments);
                for (a = 0; a < b;) c = this.points[a], c.lowerGraphic = c.graphic, c.graphic = c.upperGraphic, c._plotY = c.plotY, c._plotX = c.plotX, c.plotY = c.plotHigh, t(c.plotHighX) && (c.plotX = c.plotHighX), c._isInside = c.isInside, this.chart.polar || (c.isInside = c.isTopInside = void 0 !== c.plotY && 0 <= c.plotY && c.plotY <= this.yAxis.len && 0 <= c.plotX && c.plotX <= this.xAxis.len), a++;
                e.drawPoints.apply(this, arguments);
                for (a = 0; a < b;) c = this.points[a], c.upperGraphic =
            ...
            setState: function () {
                ...
                var b = this.series.chart.polar, c = [];
                this.plotY = this.plotLow;
    ...
    (function (a) {
        var r = a.defaultPlotOptions, v =
            a.each, t = a.merge, n = a.noop, p = a.pick, e = a.seriesType, h = a.seriesTypes.column.prototype;
        e("columnrange", "arearange", t(r.column, r.arearange, {
            ...
            translate: function () {
                var b = this, c = b.yAxis, a = b.xAxis, k = a.startAngleRad, g, d = b.chart, m = b.xAxis.isRadial,
                    u = Math.max(d.chartWidth, d.chartHeight) + 999, l;
                h.translate.apply(b);
                v(b.points, function (f) {
                    var q = f.shapeArgs, e = b.options.minPointLength, h, n;
                    f.plotHigh = l = Math.min(Math.max(-u, c.translate(f.high, 0, 1, 0, 1)), u);
                    f.plotLow =
                        Math.min(Math.max(-u, f.plotY), u);
                    n = l;
    ...
    (function (a) {
        var r = a.each, v = a.isNumber, t = a.merge, n = a.pick, p = a.pInt, e = a.Series, h = a.seriesType,
            b = a.TrackerMixin;
        h("gauge", "line", {
            dataLabels: {
                enabled: !0,
            ...
            translate: function () {
                ...
                r(this.points, function (c) {
                    var d = t(a.dial, c.dial), g = p(n(d.radius, 80)) * k[2] / 200, f = p(n(d.baseLength,
                        70)) * g / 100, l = p(n(d.rearLength, 10)) * g / 100, q = d.baseWidth || 3, e = d.topWidth || 1,
                        h = a.overshoot, x = b.startAngleRad + b.translate(c.y, null, null, null, !0);
            ...
            drawPoints: function () {
                var b =
                    this, a = b.yAxis.center, k = b.pivot, g = b.options, d = g.pivot, m = b.chart.renderer;
                r(b.points, function (c) {
                    var a = c.graphic, d = c.shapeArgs, f = d.d, k = t(g.dial, c.dial);
                ...
                k ? k.animate({
                    translateX: a[0],
                    translateY: a[1]
                }) : (b.pivot = m.circle(0, 0, n(d.radius, 5)).attr({zIndex: 2}).addClass("highcharts-pivot").translate(a[0],
                    a[1]).add(b.group), b.pivot.attr({
    ...
    (function (a) {
        var r = a.each, v = a.noop, t = a.pick, n = a.seriesType, p = a.seriesTypes;
        n("boxplot", "column", {
            threshold: null,
            ...
            pointArrayMap: ["low", "q1", "median", "q3", "high"], toYData: function (a) {
                ...
                var a = this, h = a.options,
                    b = a.chart.renderer, c, f, k, g, d, m, u = 0, l, q, p, n, x = !1 !== a.doQuartiles, v,
                    B = a.options.whiskerLength;
                r(a.points, function (e) {
                    var z = e.graphic, r = z ? "animate" : "attr", J = e.shapeArgs, w = {}, y = {}, H = {}, I = {},
                        C = e.color || a.color;
                    void 0 !== e.plotY && (l = J.width, q = Math.floor(J.x), p = q + l, n = Math.round(l / 2), c = Math.floor(x ? e.q1Plot : e.lowPlot), f = Math.floor(x ? e.q3Plot : e.lowPlot), k = Math.floor(e.highPlot), g = Math.floor(e.lowPlot), z || (e.graphic = z = b.g("point").add(a.group), e.stem = b.path().addClass("highcharts-boxplot-stem").add(z), B && (e.whiskers =
    ...
    (function (a) {
        var r = a.each, v = a.noop, t = a.seriesType, n = a.seriesTypes;
        t("errorbar", "boxplot", {
            color: "#000000",
            grouping: !1,
            linkedTo: ":previous",
            ...
            type: "errorbar", pointArrayMap: ["low", "high"], toYData: function (a) {
                return [a.low, a.high]
            }, pointValKey: "high", doQuartiles: !1, drawDataLabels: n.arearange ? function () {
                var a = this.pointValKey;
                n.arearange.prototype.drawDataLabels.call(this);
                r(this.data, function (e) {
                    e.y = e[a]
                })
            } : v, getColumnMetrics: function () {
    ...
    (function (a) {
        var r = a.correctFloat, v = a.isNumber, t = a.pick, n = a.Point, p = a.Series,
            e = a.seriesType, h = a.seriesTypes;
        e("waterfall", "column", {
            dataLabels: {inside: !0},
            lineWidth: 1,
            lineColor: "#333333",
            ...
            pointValKey: "y", translate: function () {
                var b = this.options, a = this.yAxis, f, k, g, d, m, e, l, q, p, n, x = t(b.minPointLength, 5),
                    v = x / 2, w = b.threshold, y = b.stacking, A;
                h.column.prototype.translate.apply(this);
                q = p = w;
                k = this.points;
                f = 0;
                for (b = k.length; f < b; f++) g = k[f], l = this.processedYData[f], d = g.shapeArgs, m = y && a.stacks[(this.negStacks && l < w ? "-" :
                ...
                var a = this.yData, f = this.options.data, k, g = a.length, d, m, e, l, q, h;
                m = d = e = l = this.options.threshold ||
                    0;
                for (h = 0; h < g; h++) q = a[h], k = f && f[h] ? f[h] : {}, "sum" === q || k.isSum ? a[h] = r(m) : "intermediateSum" === q || k.isIntermediateSum ? a[h] = r(d) : (m += q, d += q), e = Math.min(m, e), l = Math.max(m, l);
                ...
                var b = this.data, a = b.length, f = this.graph.strokeWidth() + this.borderWidth,
                    f = Math.round(f) % 2 / 2, k = this.xAxis.reversed, g = this.yAxis.reversed, d = [], m, e, l;
                for (l = 1; l < a; l++) {
                    e = b[l].shapeArgs;
                    m = b[l - 1].shapeArgs;
                    e = ["M", m.x + (k ? 0 : m.width), m.y + b[l - 1].minPointLengthOffset + f, "L", e.x + (k ? m.width : 0), m.y + b[l - 1].minPointLengthOffset + f];
                    if (0 > b[l - 1].y && !g || 0 < b[l - 1].y && g) e[2] += m.height, e[5] += m.height;
                    d = d.concat(e)
                }
                return d
            },
            drawGraph: function () {
                ...
                var b = this.options, a, f;
                p.prototype.setStackedPoints.apply(this, arguments);
                a = this.stackedYData ? this.stackedYData.length : 0;
                for (f = 1; f < a; f++) b.data[f].isSum || b.data[f].isIntermediateSum || (this.stackedYData[f] += this.stackedYData[f - 1])
            }, getExtremes: function () {
                if (this.options.stacking) return p.prototype.getExtremes.apply(this, arguments)
            }
        }, {
    ...
    (function (a) {
        var r = a.Series, v = a.seriesType, t = a.seriesTypes;
        v("polygon", "scatter", {
    ...
    (function (a) {
        var r = a.arrayMax, v = a.arrayMin, t = a.Axis, n = a.color, p = a.each, e = a.isNumber, h = a.noop, b = a.pick,
            c = a.pInt, f = a.Point, k = a.Series, g = a.seriesType, d = a.seriesTypes;
        g("bubble", "scatter", {
            dataLabels: {
                formatter: function () {
                    return this.point.z
            ...
            getRadii: function (b, a, c, d) {
                var g, k, f, e = this.zData, m = [], l = this.options, h = "width" !== l.sizeBy, q = l.zThreshold,
                    u = a - b;
                k = 0;
                for (g = e.length; k < g; k++) f = e[k], l.sizeByAbsoluteValue && null !== f && (f = Math.abs(f - q), a = Math.max(a - q, Math.abs(b - q)), b = 0), null === f ? f = null : f < b ? f = c / 2 - 1 : (f = 0 < u ? (f - b) / u : .5, h && 0 <= f && (f = Math.sqrt(f)), f = Math.ceil(c + f * (d - c)) / 2), m.push(f);
                this.radii = m
            },
            animate: function (b) {
                var a =
            ...
            translate: function () {
                var b, c = this.data, g, f, k = this.radii;
                d.scatter.prototype.translate.call(this);
                for (b = c.length; b--;) g = c[b], f = k ? k[b] : 0, e(f) && f >= this.minPxSize / 2 ? (g.marker = a.extend(g.marker, {
                    radius: f,
                    width: 2 * f,
                    height: 2 * f
                }), g.dlBox = {x: g.plotX - f, y: g.plotY - f, width: 2 * f, height: 2 * f}) : g.shapeArgs =
        ...
        t.prototype.beforePadding = function () {
            var a = this, d = this.len, g = this.chart, f = 0, k = d, h = this.isXAxis, n = h ? "xData" : "yData",
                t = this.min, w = {}, y = Math.min(g.plotWidth, g.plotHeight), A = Number.MAX_VALUE,
                E = -Number.MAX_VALUE, F = this.max - t, D = d / F, G = [];
            p(this.series, function (d) {
                var f = d.options;
                !d.bubblePadding ||
                !d.visible && g.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, G.push(d), h && (p(["minSize", "maxSize"], function (b) {
                    var a = f[b], d = /%$/.test(a), a = c(a);
                    w[b] = d ? y * a / 100 : a
            ...
            p(G, function (b) {
                var c = b[n], d = c.length, g;
                h && b.getRadii(A, E, b.minPxSize, b.maxPxSize);
                if (0 < F) for (; d--;) e(c[d]) && a.dataMin <=
    ...
    (function (a) {
        var r = a.each, v = a.pick, t = a.seriesTypes, n = a.wrap, p = a.Series.prototype, e = a.Pointer.prototype;
        if (!a.polarExtended) {
            a.polarExtended = !0;
            p.searchPointByAngle = function (b) {
                var a = this.chart, f = this.xAxis.pane.center;
            ...
            p.getConnectors = function (b, a, f, k) {
                ...
                n = Math.PI / 2 + (h +
                    Math.atan2(n - c, l - d)) / 2;
                Math.abs(h - n) > Math.PI / 2 && (n -= Math.PI);
                h = d + Math.cos(n) * p;
                e = c + Math.sin(n) * p;
                l = d + Math.cos(Math.PI + n) * r;
                n = c + Math.sin(Math.PI + n) * r;
                d = {rightContX: l, rightContY: n, leftContX: h, leftContY: e, plotX: d, plotY: c};
            ...
            t.spline && (n(t.spline.prototype, "getPointSpline", function (b, a, f, k) {
                this.chart.polar ? k ? (b = this.getConnectors(a, k, !0, this.connectEnds), b = ["C", b.prevPointCont.rightContX, b.prevPointCont.rightContY, b.leftContX, b.leftContY, b.plotX, b.plotY]) : b = ["M",
                    f.plotX, f.plotY] : b = b.call(this, a, f, k);
                return b
            ...
            a.addEvent(p, "afterTranslate", function () {
                var b = this.chart, c, f;
                if (b.polar) {
                    this.kdByAngle = b.tooltip && b.tooltip.shared;
                    if (!this.preventPostTranslate) for (c = this.points, f = c.length; f--;) this.toXY(c[f]);
                    this.hasClipCircleSetter || (this.hasClipCircleSetter = !!a.addEvent(this, "afterRender", function () {
                        var c;
                        b.polar && (c = this.yAxis.center, this.group.clip(b.renderer.clipCircle(c[0],
            ...
            var h = function (b, a) {
                var c = this.chart, e = this.options.animation, g = this.group, d = this.markerGroup,
                    h = this.xAxis.center,
                    n = c.plotLeft, l = c.plotTop;
            ...
            t.column && (t = t.column.prototype, t.polarArc = function (b, a, f, e) {
                var c = this.xAxis.center, d = this.yAxis.len;
                return this.chart.renderer.symbols.arc(c[0], c[1], d - a, null, {start: f, end: e, innerR: d - v(b, d)})
            }, n(t, "animate",
                h), n(t, "translate", function (a) {
                var b = this.xAxis, f = b.startAngleRad, e, g, d;
                this.preventPostTranslate = !0;
                a.call(this);
                if (b.isRadial) for (e = this.points, d = e.length; d--;) g = e[d], a = g.barX + f, g.shapeType = "path", g.shapeArgs = {d: this.polarArc(g.yBottom, g.plotY, a, a + g.pointWidth)}, this.toXY(g), g.tooltipPos = [g.plotX, g.plotY], g.ttBelow = g.plotY > b.center[1]
            ...
            n(e, "getCoordinates", function (a, c) {
                ...
                b.polar ? r(b.axes, function (a) {
                    var d = a.isXAxis, f = a.center, g = c.chartX - f[0] - b.plotLeft, f = c.chartY - f[1] - b.plotTop;
