...
public class ProjectPersonalFragment extends Fragment{
    ...
    public static Fragment newInstance() {
        ProjectPersonalFragment fragment = new ProjectPersonalFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_project_personal, container, false);
