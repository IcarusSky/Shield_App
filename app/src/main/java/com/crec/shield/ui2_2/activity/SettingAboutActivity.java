...
public class SettingAboutActivity  extends BaseActivity implements View.OnClickListener {
    ...
    private static final String ACTIVITY_TAG="SettingAboutActivity";
    ...
    @Override
        ...
        protected void setStatusBar() {
            super.setStatusBar();
            StatusBarUtil.setColor(SettingAboutActivity.this, getResources().getColor(R.color.AppBluePri));
        }
