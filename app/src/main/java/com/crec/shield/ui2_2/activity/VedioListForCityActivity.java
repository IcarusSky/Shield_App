...
import com.crec.shield.adapter.CityVedioAdapter;
...
public class VedioListForCityActivity extends BaseActivity<ProjectListForCityPresenter> implements ProjectListForCityContract.View{
    //数据绑定
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter = new CityVedioAdapter(VedioListForCityActivity.this, getChackDate());
    ...
    private void showListView() {
        ...
        adapter = new CityVedioAdapter(VedioListForCityActivity.this, checkData);
        mRecyclerView.setAdapter(adapter);
    }
