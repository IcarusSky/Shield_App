...
public class ProjectSourceRiskActivity  extends BaseActivity implements View.OnClickListener {
        ...
        /*public static Fragment newInstance() {
            fragment = new com.crec.shield.ui.fragment.ProjectDetailsRiskFragment();
            return fragment;
        }*/
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_project_source_risk);
...
/* @Nullable
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            v = inflater.inflate(R.layout.activity_project_source_risk, container, false);
...
*/
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.btn_left:
                    ...
                    break;
                case R.id.btn_right:
                    Intent intent = new Intent(ProjectSourceRiskActivity.this, HomeActivity.class);
        ...
        private void initGroundSetting() {
            ...
            GroundSettingChart.addJavascriptInterface(this, "android");
        ...
        private void initRiskCount() {
            ...
            RiskChart.addJavascriptInterface(this, "android");
