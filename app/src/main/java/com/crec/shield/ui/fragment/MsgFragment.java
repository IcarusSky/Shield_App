 ...
 */
public class MsgFragment extends Fragment implements View.OnClickListener, OnRefreshListener {
...
//        sqlHelper = DBManager.getInstance(getContext());
//        db = sqlHelper.getWritableDatabase();
        ...
        mUnbinder=ButterKnife.bind(view);  //保存引用
        return view;
